...
const SIPCalculator = () => {
  ...
  const exportToPDF = () => {
    ...
    doc.text('SIP Calculator Report', pageWidth / 2, 18, { align: 'center' });
    doc.setFontSize(10);
    ...
    doc.setFontSize(14);
    doc.setFont('helvetica', 'bold');
    doc.text('Investment Parameters', 14, 45);
    ...
    doc.setFontSize(14);
    doc.setFont('helvetica', 'bold');
    doc.text('Investment Summary', 14, currentY);
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ['Wealth Gain', `${((result.totalReturns / result.totalInvested) * 100).toFixed(1)}%`],
      ],
      theme: 'striped',
    ...
    // Formula
    currentY = (doc as any).lastAutoTable?.finalY + 15 || 140;
    doc.setFontSize(10);
    doc.setFont('helvetica', 'normal');
    doc.text('SIP Formula: M = P × ({[1 + r]^n – 1} / r) × (1 + r)', 14, currentY);
    doc.text('Where: P = Monthly investment, r = Monthly interest rate, n = Number of months', 14, currentY + 6);
