  ...
  const generateContract = () => {
    ...
    switch (details.contractType) {
      case "employment":
        ...
        contract += `The Second Party shall devote their full time, attention, and abilities to the performance of duties and shall act in the best interests of the First Party at all times.\n\n`;
        contract += `2. COMPENSATION AND BENEFITS\n`;
        contract += `  a) The First Party shall pay the Second Party a gross salary of ₹${details.amount || "[Amount]"} per annum (Cost to Company), payable in monthly installments.\n`;
        contract += `  b) Salary Structure:\n`;
        contract += `    - Basic Salary: [Amount] per annum\n`;
        contract += `    - House Rent Allowance (HRA): [Amount] per annum\n`;
        contract += `    - Special Allowance: [Amount] per annum\n`;
        contract += `    - Provident Fund (Employer Contribution): As per statutory requirements\n`;
        contract += `    - Gratuity: As per Payment of Gratuity Act, 1972\n`;
        contract += `  c) Performance Bonus: Subject to annual appraisal and company performance.\n`;
        contract += `  d) Annual Increment: Subject to satisfactory performance review.\n\n`;
        contract += `3. TERM OF EMPLOYMENT\n`;
        contract += `This Agreement shall commence on ${details.effectiveDate || "[Start Date]"} and shall continue until ${details.endDate || "[End Date]"} unless terminated earlier in accordance with this Agreement.\n\n`;
        contract += `4. PROBATION PERIOD\n`;
        contract += `  a) The Second Party shall be on probation for a period of [Duration] from the date of joining.\n`;
        contract += `  b) During probation, either party may terminate employment with [7/15] days' written notice.\n`;
        contract += `  c) Upon successful completion of probation, the Second Party shall be confirmed in writing.\n`;
        contract += `  d) The probation period may be extended by [Duration] if performance is unsatisfactory.\n\n`;
        contract += `5. WORKING HOURS AND LEAVE\n`;
        contract += `  a) Standard working hours shall be [Number] hours per week, [Days] days a week.\n`;
        contract += `  b) Paid Leave: [Number] days of earned/privilege leave per year.\n`;
        contract += `  c) Sick Leave: [Number] days per year (with medical certificate for 3+ consecutive days).\n`;
        contract += `  d) Casual Leave: [Number] days per year.\n`;
        contract += `  e) Public Holidays: As per the company holiday calendar.\n`;
        contract += `  f) Maternity/Paternity Leave: As per the Maternity Benefit Act, 1961 / company policy.\n\n`;
        contract += `6. CONFIDENTIALITY AND NON-DISCLOSURE\n`;
        contract += `  a) The Second Party shall not disclose any confidential information, trade secrets, proprietary data, or business strategies of the First Party during or after employment.\n`;
        contract += `  b) "Confidential Information" includes but is not limited to client lists, financial data, business plans, technical know-how, algorithms, and internal processes.\n`;
        contract += `  c) This obligation shall survive the termination of this Agreement for a period of [Duration] years.\n\n`;
        contract += `7. INTELLECTUAL PROPERTY\n`;
        contract += `  a) All inventions, designs, works, software, and creative output produced during employment shall be the exclusive property of the First Party.\n`;
        contract += `  b) The Second Party hereby assigns all rights, title, and interest in such intellectual property to the First Party.\n`;
        contract += `  c) The Second Party shall execute any documents necessary to perfect such assignment.\n\n`;
        contract += `8. NON-COMPETE AND NON-SOLICITATION\n`;
        contract += `  a) During employment and for [Duration] months after termination, the Second Party shall not engage in any business competing with the First Party within ${details.jurisdiction || "[Geographic Area]"}.\n`;
        contract += `  b) The Second Party shall not solicit, recruit, or hire any employee or contractor of the First Party for [Duration] months after termination.\n`;
        contract += `  c) The Second Party shall not solicit or divert any clients or customers of the First Party for [Duration] months after termination.\n\n`;
        contract += `9. TERMINATION\n`;
        contract += `  a) By Notice: Either party may terminate this Agreement by giving [Notice Period] written notice.\n`;
        contract += `  b) For Cause: The First Party may terminate immediately for gross misconduct, fraud, breach of confidentiality, or criminal conviction.\n`;
        contract += `  c) Pay in Lieu: The First Party may pay salary in lieu of the notice period.\n`;
        contract += `  d) Resignation: The Second Party must serve the full notice period unless waived in writing.\n`;
        contract += `  e) Garden Leave: The First Party reserves the right to place the Second Party on garden leave during the notice period.\n\n`;
        contract += `10. SEPARATION AND EXIT\n`;
        contract += `  a) Upon termination, the Second Party shall return all company property, documents, devices, and access credentials within [Number] working days.\n`;
        contract += `  b) Full and final settlement shall be processed within [30/45] days of the last working day.\n`;
        contract += `  c) The Second Party shall cooperate in knowledge transfer and handover of responsibilities.\n`;
        contract += `  d) Any outstanding loans or advances shall be adjusted against the final settlement.\n\n`;
        contract += `11. CODE OF CONDUCT\n`;
        contract += `  a) The Second Party shall comply with all company policies, including the Employee Handbook, Anti-Harassment Policy, and IT Security Policy.\n`;
        contract += `  b) The Second Party shall not engage in any activity that may bring disrepute to the First Party.\n`;
        contract += `  c) Conflicts of Interest: The Second Party shall disclose any personal or financial interests that may conflict with their duties.\n\n`;
        contract += `12. INDEMNIFICATION\n`;
        contract += `The Second Party shall indemnify and hold harmless the First Party against any losses, damages, or claims arising from the Second Party's negligence, misconduct, or breach of this Agreement.\n\n`;
        contract += `13. BACKGROUND VERIFICATION\n`;
        contract += `This employment is contingent upon satisfactory completion of background verification, including educational qualifications, previous employment, and criminal record checks.\n\n`;
        break;
      ...
      case "nda":
        ...
        contract += `WHEREAS, the parties desire to protect such confidential information from unauthorized use or disclosure.\n\n`;
        contract += `NOW, THEREFORE, in consideration of the mutual promises herein, the parties agree as follows:\n\n`;
        contract += `1. DEFINITION OF CONFIDENTIAL INFORMATION\n`;
        contract += `"Confidential Information" means any and all information disclosed by either party, whether orally, in writing, electronically, or by inspection, including but not limited to:\n`;
        contract += `  a) Trade secrets, inventions, patents, copyrights, and know-how.\n`;
        contract += `  b) Business plans, strategies, financial data, projections, and forecasts.\n`;
        contract += `  c) Customer and supplier lists, pricing information, and marketing plans.\n`;
        contract += `  d) Technical data, designs, algorithms, source code, and specifications.\n`;
        contract += `  e) Personnel information, organizational structure, and compensation data.\n`;
        contract += `  f) Any information marked as "Confidential" or reasonably understood to be confidential.\n\n`;
        contract += `2. EXCLUSIONS FROM CONFIDENTIAL INFORMATION\n`;
        contract += `Confidential Information shall NOT include information that:\n`;
        contract += `  a) Is or becomes publicly available through no fault of the Receiving Party.\n`;
        contract += `  b) Was already known to the Receiving Party prior to disclosure (with documentary evidence).\n`;
        contract += `  c) Is independently developed by the Receiving Party without use of Confidential Information.\n`;
        contract += `  d) Is lawfully received from a third party without restriction on disclosure.\n`;
        contract += `  e) Is required to be disclosed by law, regulation, or court order (with prompt notice to Disclosing Party).\n\n`;
        contract += `3. PURPOSE\n`;
        ...
        contract += `4. NON-DISCLOSURE OBLIGATIONS\n`;
        contract += `The Receiving Party agrees to:\n`;
        contract += `  a) Hold and maintain all Confidential Information in strict confidence.\n`;
        contract += `  b) Not disclose Confidential Information to any third party without prior written consent.\n`;
        contract += `  c) Use Confidential Information solely for the Purpose stated herein.\n`;
        contract += `  d) Limit access to Confidential Information to employees and advisors who have a need-to-know and are bound by similar confidentiality obligations.\n`;
        contract += `  e) Protect Confidential Information with at least the same degree of care used for its own confidential information, but no less than reasonable care.\n`;
        contract += `  f) Promptly notify the Disclosing Party of any unauthorized use or disclosure.\n\n`;
        contract += `5. PERMITTED DISCLOSURES\n`;
        contract += `  a) To professional advisors (lawyers, auditors, accountants) bound by professional confidentiality duties.\n`;
        contract += `  b) As required by applicable law, regulation, or governmental authority, provided the Receiving Party gives prior written notice and cooperates to obtain protective orders.\n`;
        contract += `  c) To affiliates and subsidiaries who are bound by obligations no less restrictive than this Agreement.\n\n`;
        contract += `6. INTELLECTUAL PROPERTY\n`;
        contract += `  a) No license, ownership, or intellectual property rights are granted by the Disclosing Party through disclosure of Confidential Information.\n`;
        contract += `  b) All Confidential Information remains the exclusive property of the Disclosing Party.\n`;
        contract += `  c) No right to use Confidential Information for any purpose other than the stated Purpose.\n\n`;
        contract += `7. NON-SOLICITATION\n`;
        contract += `During the term of this Agreement and for [Duration] months thereafter, neither party shall directly or indirectly solicit, recruit, or hire any employee or contractor of the other party.\n\n`;
        contract += `8. RETURN AND DESTRUCTION OF INFORMATION\n`;
        contract += `  a) Upon termination or written request, the Receiving Party shall promptly return or destroy all Confidential Information, including all copies, notes, and derivative materials.\n`;
        contract += `  b) The Receiving Party shall certify in writing that all Confidential Information has been returned or destroyed.\n`;
        contract += `  c) Notwithstanding the above, the Receiving Party may retain one archival copy solely for legal compliance purposes.\n\n`;
        contract += `9. REMEDIES FOR BREACH\n`;
        contract += `  a) The parties acknowledge that a breach may cause irreparable harm not adequately compensated by monetary damages.\n`;
        contract += `  b) The Disclosing Party shall be entitled to seek injunctive relief, specific performance, and any other equitable remedies.\n`;
        contract += `  c) The breaching party shall be liable for all damages, costs, and attorney's fees incurred.\n`;
        contract += `  d) Liquidated Damages: In addition to equitable relief, the breaching party shall pay ₹${details.amount || "[Amount]"} as pre-estimated damages per breach.\n\n`;
        contract += `10. TERM AND SURVIVAL\n`;
        contract += `  a) This Agreement shall remain in effect from ${details.effectiveDate || "[Start Date]"} to ${details.endDate || "[End Date]"}.\n`;
        contract += `  b) The confidentiality obligations shall survive termination for a period of [Duration] years.\n`;
        contract += `  c) Obligations with respect to trade secrets shall survive indefinitely.\n\n`;
        contract += `11. NO WARRANTY\n`;
        contract += `All Confidential Information is provided "AS IS." The Disclosing Party makes no representations or warranties as to the accuracy, completeness, or reliability of the Confidential Information.\n\n`;
        contract += `12. NO OBLIGATION TO PROCEED\n`;
        contract += `This Agreement does not obligate either party to enter into any further agreement or business relationship. Either party may terminate discussions at any time without liability.\n\n`;
        break;
      ...
      case "share-purchase":
        contract += `RECITALS:\n`;
        contract += `WHEREAS, the Seller is the legal and beneficial owner of certain shares in [Company Name] ("the Company").\n`;
        contract += `WHEREAS, the Buyer desires to purchase and the Seller desires to sell the said shares on the terms and conditions set forth herein.\n\n`;
        contract += `NOW, THEREFORE, in consideration of the mutual covenants herein, the parties agree as follows:\n\n`;
        contract += `1. SALE AND PURCHASE OF SHARES\n`;
        contract += `  a) The Seller agrees to sell and the Buyer agrees to purchase [Number] [equity/preference] shares of the Company ("Sale Shares").\n`;
        contract += `  b) The Sale Shares represent [Percentage]% of the total issued and paid-up share capital of the Company.\n`;
        contract += `  c) Class of Shares: [Equity / Preference / Convertible]\n`;
        contract += `  d) Face Value: ₹[Value] per share\n`;
        contract += `  e) Share Certificate Numbers: [Numbers] to [Numbers]\n\n`;
        contract += `2. PURCHASE PRICE AND PAYMENT\n`;
        contract += `  a) The total purchase price for the Sale Shares shall be ₹${details.amount || "[Amount]"} ("Purchase Price").\n`;
        contract += `  b) Price Per Share: ₹[Amount]\n`;
        contract += `  c) Payment Schedule:\n`;
        contract += `    - Advance/Earnest Money: ₹[Amount] upon execution of this Agreement\n`;
        contract += `    - Balance: ₹[Amount] at Closing\n`;
        contract += `  d) Payment Method: Wire transfer to the Seller's designated bank account.\n`;
        contract += `  e) Escrow: [Amount/Percentage] of the Purchase Price shall be held in escrow for [Duration] to secure indemnification obligations.\n\n`;
        contract += `3. DESCRIPTION OF SHARES\n`;
        contract += `${details.purpose || "The shares being sold are [Class] shares with a face value of ₹[Value] each, fully paid-up and carrying all rights attached thereto."}\n\n`;
        contract += `4. CONDITIONS PRECEDENT\n`;
        contract += `Completion of this transaction is subject to:\n`;
        contract += `  a) Board resolution of the Company approving the transfer.\n`;
        contract += `  b) Waiver of pre-emptive rights / ROFR by existing shareholders.\n`;
        contract += `  c) Receipt of all regulatory approvals (RBI/FEMA for cross-border transfers).\n`;
        contract += `  d) No Material Adverse Change in the Company's business.\n`;
        contract += `  e) Satisfactory completion of due diligence by the Buyer.\n`;
        contract += `  f) Execution of Deed of Adherence to existing Shareholders' Agreement (if applicable).\n`;
        contract += `  g) All third-party consents as may be required.\n\n`;
        contract += `5. REPRESENTATIONS AND WARRANTIES BY THE SELLER\n`;
        contract += `The Seller represents and warrants that:\n`;
        contract += `  a) The Seller is the sole legal and beneficial owner of the Sale Shares.\n`;
        contract += `  b) The Sale Shares are free from all liens, charges, encumbrances, and adverse claims.\n`;
        contract += `  c) The Seller has full authority and capacity to sell and transfer the Sale Shares.\n`;
        contract += `  d) No third party has any right, option, or claim over the Sale Shares.\n`;
        contract += `  e) All information provided about the Company is true, accurate, and complete.\n`;
        contract += `  f) The Company has no undisclosed liabilities or pending litigation that may materially affect the value of the Sale Shares.\n`;
        contract += `  g) The Company is in compliance with all applicable laws and regulations.\n`;
        contract += `  h) All taxes (including capital gains tax) arising from this transfer shall be borne by the Seller.\n`;
        contract += `  i) The Seller is not in breach of any shareholders' agreement or other contract by entering into this transaction.\n\n`;
        contract += `6. REPRESENTATIONS AND WARRANTIES BY THE BUYER\n`;
        contract += `The Buyer represents and warrants that:\n`;
        contract += `  a) The Buyer has full legal capacity and authority to purchase the Sale Shares.\n`;
        contract += `  b) Funds for the purchase are from legitimate sources.\n`;
        contract += `  c) The Buyer is aware of the Company's affairs and is purchasing the shares based on independent assessment.\n\n`;
        contract += `7. CLOSING AND TRANSFER\n`;
        contract += `  a) The Closing shall take place on ${details.effectiveDate || "[Closing Date]"} at [Location/Virtually].\n`;
        contract += `  b) At Closing, the Seller shall deliver:\n`;
        contract += `    - Duly executed Share Transfer Form(s) (Form SH-4)\n`;
        contract += `    - Original Share Certificate(s)\n`;
        contract += `    - Board Resolution approving the transfer\n`;
        contract += `    - Waiver letters from other shareholders (if applicable)\n`;
        contract += `    - No Objection Certificate from the Company\n`;
        contract += `  c) The Buyer shall transfer the balance Purchase Price simultaneously.\n`;
        contract += `  d) The Company shall register the transfer within [7] working days and issue new share certificates.\n\n`;
        contract += `8. POST-CLOSING OBLIGATIONS\n`;
        contract += `  a) The Seller shall cooperate in filing necessary regulatory forms.\n`;
        contract += `  b) The Seller shall not compete with the Company for [Duration] months (if applicable).\n`;
        contract += `  c) Transition assistance for [Duration] days after Closing.\n`;
        contract += `  d) The Company shall update ROC filings within statutory timelines.\n\n`;
        contract += `9. INDEMNIFICATION\n`;
        contract += `  a) The Seller shall indemnify the Buyer against any losses, damages, or claims arising from:\n`;
        contract += `    - Breach of any representations or warranties\n`;
        contract += `    - Pre-Closing liabilities of the Company not disclosed to the Buyer\n`;
        contract += `    - Any tax claims relating to the period before Closing\n`;
        contract += `  b) Indemnification Cap: [Percentage]% of the Purchase Price.\n`;
        contract += `  c) Indemnification Basket: Minimum aggregate claims of ₹[Amount] before indemnification is triggered.\n`;
        contract += `  d) Survival Period: [Duration] years from Closing (unlimited for fraud and tax matters).\n\n`;
        contract += `10. NON-COMPETE AND NON-SOLICITATION\n`;
        contract += `  a) The Seller shall not engage in any business competing with the Company for [Duration] months after Closing.\n`;
        contract += `  b) The Seller shall not solicit any employees, clients, or suppliers of the Company for [Duration] months.\n\n`;
        contract += `11. CONFIDENTIALITY\n`;
        contract += `Both parties shall keep the terms of this Agreement and all information exchanged during negotiations strictly confidential.\n\n`;
        contract += `12. TERMINATION\n`;
        contract += `  a) This Agreement may be terminated by mutual written consent.\n`;
        contract += `  b) Either party may terminate if Closing has not occurred by the Long-Stop Date: ${details.endDate || "[Date]"}.\n`;
        contract += `  c) The Buyer may terminate if any representation or warranty is found to be materially untrue.\n`;
        contract += `  d) Upon termination, all advance payments shall be refunded within [Duration] days.\n\n`;
        break;

      case "non-compete":
        contract += `RECITALS:\n`;
        contract += `WHEREAS, the parties are entering into or have entered into a business relationship and the First Party wishes to protect its legitimate business interests, including trade secrets, confidential information, client relationships, and goodwill.\n\n`;
        contract += `NOW, THEREFORE, in consideration of the mutual covenants and the consideration described herein, the parties agree as follows:\n\n`;
        ...
        contract += `  a) Own, manage, operate, join, control, or participate in any business that competes with the First Party's business.\n`;
        contract += `  b) Act as an officer, director, employee, consultant, advisor, or agent of any competing entity.\n`;
        contract += `  c) Invest in any competing business (except passive investments of less than 5% in publicly traded companies).\n`;
        contract += `  d) Establish or assist in establishing any competing enterprise.\n\n`;
        contract += `2. NON-SOLICITATION OF CLIENTS\n`;
        contract += `  a) The Second Party shall not solicit, contact, or attempt to solicit any client, customer, or account of the First Party for competing purposes.\n`;
        contract += `  b) This restriction applies to all clients with whom the Second Party had dealings during the last [Duration] months of their relationship with the First Party.\n`;
        contract += `  c) The Second Party shall not interfere with or attempt to disrupt any business relationship between the First Party and its clients, vendors, or partners.\n\n`;
        contract += `3. NON-SOLICITATION OF EMPLOYEES\n`;
        contract += `  a) The Second Party shall not recruit, solicit, hire, or attempt to recruit any employee, contractor, or consultant of the First Party.\n`;
        contract += `  b) The Second Party shall not encourage any employee of the First Party to leave their employment.\n`;
        contract += `  c) This restriction shall apply for [Duration] months after termination of this Agreement.\n\n`;
        contract += `4. GEOGRAPHIC SCOPE\n`;
        contract += `  a) This non-compete restriction applies within ${details.jurisdiction || "[Geographic Area/Territory]"} and any territory where the First Party conducts business or has active clients.\n`;
        contract += `  b) The parties acknowledge that this geographic scope is reasonable given the nature of the First Party's business.\n\n`;
        contract += `5. SCOPE OF RESTRICTED ACTIVITIES\n`;
        contract += `${details.purpose || "The restricted activities include [Description of Competing Business Activities]."}\n`;
        contract += `  a) The term "Competing Business" means any business engaged in [Industry/Activity] that is substantially similar to the First Party's current or planned business operations.\n`;
        contract += `  b) "Indirect" competition includes acting through family members, associates, trusts, or entities controlled by the Second Party.\n\n`;
        contract += `6. CONSIDERATION\n`;
        contract += `  a) In consideration for the non-compete obligations, the First Party shall pay ₹${details.amount || "[Amount]"} to the Second Party.\n`;
        contract += `  b) The Second Party acknowledges that the consideration is adequate and sufficient.\n`;
        contract += `  c) Additional consideration includes access to confidential information, specialized training, and client relationships.\n\n`;
        contract += `7. CONFIDENTIALITY\n`;
        contract += `  a) The Second Party shall not use or disclose any trade secrets, proprietary information, or confidential business information of the First Party.\n`;
        contract += `  b) This includes customer data, pricing strategies, business methods, financial information, and technical know-how.\n`;
        contract += `  c) The confidentiality obligation shall survive indefinitely for trade secrets.\n\n`;
        contract += `8. TERM\n`;
        ...
        contract += `9. REMEDIES FOR BREACH\n`;
        contract += `  a) The parties acknowledge that a breach would cause irreparable harm to the First Party.\n`;
        contract += `  b) The First Party shall be entitled to seek injunctive relief and temporary restraining orders without posting bond.\n`;
        contract += `  c) The First Party may recover actual damages, lost profits, and consequential damages.\n`;
        contract += `  d) The breaching party shall be liable for all attorney's fees, court costs, and enforcement expenses.\n`;
        contract += `  e) The non-compete period shall be extended by the duration of any breach.\n\n`;
        contract += `10. JUDICIAL MODIFICATION (BLUE PENCIL DOCTRINE)\n`;
        contract += `If any court finds any provision of this non-compete to be overly broad in scope, duration, or geographic area, the court is empowered to modify and enforce it to the maximum extent permissible by law.\n\n`;
        contract += `11. REASONABLENESS\n`;
        contract += `  a) Both parties acknowledge that the restrictions are reasonable and necessary for the protection of the First Party's legitimate business interests.\n`;
        contract += `  b) The Second Party has had the opportunity to seek independent legal counsel before signing this Agreement.\n`;
        contract += `  c) The restrictions do not impose undue hardship on the Second Party's ability to earn a livelihood.\n\n`;
        contract += `12. ASSIGNMENT\n`;
        contract += `The First Party may assign this Agreement to any successor, acquirer, or entity that acquires substantially all of its business or assets. The Second Party may not assign any rights or obligations under this Agreement.\n\n`;
        break;
      ...
      case "offer-letter":
        ...
        contract += `  Employment Type: [Full-Time / Part-Time / Contract]\n\n`;
        contract += `2. START DATE\n`;
        contract += `Your employment is expected to commence on ${details.effectiveDate || "[Start Date]"}. Please confirm your availability to join on this date.\n\n`;
        contract += `3. COMPENSATION\n`;
        contract += `  Annual CTC: ₹${details.amount || "[Amount]"}\n`;
        contract += `  The compensation structure is as follows:\n`;
        contract += `  a) Basic Salary: ₹[Amount] per annum (40% of CTC)\n`;
        contract += `  b) House Rent Allowance (HRA): ₹[Amount] per annum\n`;
        contract += `  c) Special Allowance: ₹[Amount] per annum\n`;
        contract += `  d) Conveyance Allowance: ₹[Amount] per annum\n`;
        contract += `  e) Medical Allowance: ₹[Amount] per annum\n`;
        contract += `  f) Provident Fund (Employer Contribution): 12% of Basic as per EPF Act\n`;
        contract += `  g) Gratuity: As per Payment of Gratuity Act, 1972\n`;
        contract += `  h) Performance Bonus: Up to [Percentage]% of CTC, based on individual and company performance.\n`;
        contract += `  i) ESOP/RSU (if applicable): [Number] units vesting over [Duration] years.\n\n`;
        contract += `4. PROBATION PERIOD\n`;
        contract += `  a) You will be on probation for [Duration] months from the date of joining.\n`;
        contract += `  b) During probation, either party may terminate employment with [7/15] days' written notice.\n`;
        contract += `  c) Confirmation will be based on satisfactory performance evaluation.\n\n`;
        contract += `5. WORKING HOURS\n`;
        contract += `  a) Standard working hours: [Number] hours per day, [Days] days per week.\n`;
        contract += `  b) Flexible working / hybrid arrangement: [Details if applicable].\n`;
        contract += `  c) Overtime policy: As per company policy and applicable labor laws.\n\n`;
        contract += `6. LEAVE ENTITLEMENT\n`;
        contract += `  a) Earned/Privilege Leave: [Number] days per year\n`;
        contract += `  b) Sick Leave: [Number] days per year\n`;
        contract += `  c) Casual Leave: [Number] days per year\n`;
        contract += `  d) Public/National Holidays: As per company holiday calendar\n`;
        contract += `  e) Maternity/Paternity Leave: As per statutory provisions\n\n`;
        contract += `7. BENEFITS\n`;
        contract += `  a) Group Medical Insurance: Coverage for self, spouse, and up to 2 children (Sum Insured: ₹[Amount])\n`;
        contract += `  b) Group Term Life Insurance: Coverage of [X] times annual CTC\n`;
        contract += `  c) Group Personal Accident Insurance: As per company policy\n`;
        contract += `  d) Learning & Development: Annual training budget of ₹[Amount]\n`;
        contract += `  e) Relocation Assistance: [If applicable, details]\n`;
        contract += `  f) Other Benefits: [Meal allowance, gym membership, etc.]\n\n`;
        contract += `8. NOTICE PERIOD\n`;
        contract += `  a) During probation: [7/15] days\n`;
        contract += `  b) After confirmation: [30/60/90] days\n`;
        contract += `  c) The company reserves the right to waive or pay salary in lieu of notice period.\n\n`;
        contract += `9. CONFIDENTIALITY AND NON-DISCLOSURE\n`;
        contract += `You will be required to sign a separate Non-Disclosure Agreement (NDA) on or before your date of joining. You shall maintain confidentiality of all proprietary and business information.\n\n`;
        contract += `10. NON-COMPETE AND NON-SOLICITATION\n`;
        contract += `  a) During employment and for [Duration] months post-employment, you agree not to join or assist any competing business.\n`;
        contract += `  b) You shall not solicit company clients or recruit company employees during and after employment.\n\n`;
        contract += `11. INTELLECTUAL PROPERTY\n`;
        contract += `All inventions, work product, and intellectual property created during your employment shall be the exclusive property of ${details.party1Name}.\n\n`;
        contract += `12. TERMS AND CONDITIONS\n`;
        contract += `This offer is subject to:\n`;
        contract += `  a) Successful completion of background verification (education, employment, criminal records)\n`;
        contract += `  b) Submission of required documents (ID proof, address proof, educational certificates, relieving letter, last 3 months' payslips)\n`;
        contract += `  c) Satisfactory medical fitness examination\n`;
        contract += `  d) Acceptance of company policies, Employee Handbook, and Code of Conduct\n`;
        contract += `  e) Serving the full notice period at your current employer\n\n`;
        contract += `13. AT-WILL EMPLOYMENT / TERMINATION\n`;
        contract += `  a) After confirmation, either party may terminate employment by serving the notice period as stated above.\n`;
        contract += `  b) The company may terminate employment immediately for cause, including misconduct, fraud, or breach of company policies.\n\n`;
        contract += `14. ACCEPTANCE\n`;
        contract += `Please sign and return this offer letter by ${details.endDate || "[Acceptance Deadline]"} to confirm your acceptance. If not accepted by this date, this offer shall stand automatically withdrawn.\n\n`;
        contract += `We look forward to having you on our team!\n\n`;
        contract += `Warm regards,\n`;
        contract += `${details.party1Name}\n`;
        contract += `[Authorized Signatory Name & Designation]\n\n`;
        contract += `ACCEPTANCE BY CANDIDATE:\n`;
        contract += `I, ${details.party2Name}, hereby accept this offer of employment and agree to the terms and conditions stated above.\n\n`;
      ...
      case "shareholders":
        contract += `RECITALS:\n`;
        contract += `WHEREAS, the parties are shareholders of [Company Name] ("the Company"), a company incorporated under the Companies Act, 2013, with CIN: [CIN Number].\n`;
        contract += `WHEREAS, the parties wish to regulate their rights, obligations, and the management of the Company and to provide for the governance and operation of the Company.\n\n`;
        contract += `NOW, THEREFORE, in consideration of the mutual covenants herein, the parties agree as follows:\n\n`;
        contract += `1. DEFINITIONS AND INTERPRETATION\n`;
        contract += `  a) "Affiliate" means any entity that directly or indirectly controls, is controlled by, or is under common control with a party.\n`;
        contract += `  b) "Business" means [Description of the Company's business activities].\n`;
        contract += `  c) "Fair Market Value" shall be determined by an independent valuer appointed by mutual consent.\n`;
        contract += `  d) "Reserved Matters" means the matters listed in Schedule A requiring special approval.\n\n`;
        contract += `2. SHARE CAPITAL AND OWNERSHIP\n`;
        contract += `  a) The authorized share capital of the Company is ₹[Amount].\n`;
        contract += `  b) The total issued and paid-up share capital of the Company is ₹${details.amount || "[Amount]"}.\n`;
        contract += `  c) The shareholding pattern is as follows:\n`;
        contract += `    - ${details.party1Name}: [Number] equity shares ([Percentage]%)\n`;
        contract += `    - ${details.party2Name}: [Number] equity shares ([Percentage]%)\n`;
        contract += `  d) No party shall hold shares through nominees without prior written consent of other shareholders.\n\n`;
        contract += `3. BOARD OF DIRECTORS\n`;
        contract += `  a) The Board shall consist of [Number] directors, constituted as follows:\n`;
        contract += `    - ${details.party1Name} shall be entitled to nominate [Number] director(s).\n`;
        contract += `    - ${details.party2Name} shall be entitled to nominate [Number] director(s).\n`;
        contract += `    - [Number] independent director(s) shall be appointed by mutual consent.\n`;
        contract += `  b) The Chairperson shall be nominated by [Party holding majority / rotating basis].\n`;
        contract += `  c) Board meetings shall be held at least once every quarter with minimum [Number] days' prior notice.\n`;
        contract += `  d) Quorum shall be [Number] directors, including at least one nominee from each shareholder.\n`;
        contract += `  e) Board decisions shall be by simple majority unless otherwise specified.\n\n`;
        contract += `4. MANAGEMENT AND DECISION MAKING\n`;
        contract += `  a) Day-to-day management shall be handled by the Managing Director/CEO appointed by the Board.\n`;
        contract += `  b) Key Management Personnel (KMP) appointments shall require Board approval.\n`;
        contract += `  c) Reserved Matters requiring unanimous/supermajority ([Percentage]%) consent:\n`;
        contract += `    - Amendment of Memorandum or Articles of Association\n`;
        contract += `    - Issuance of new shares, convertible instruments, or ESOPs\n`;
        contract += `    - Mergers, acquisitions, demergers, or sale of substantial assets (>₹[Threshold])\n`;
        contract += `    - Capital expenditure exceeding ₹[Threshold] per transaction or ₹[Threshold] annually\n`;
        contract += `    - Related party transactions exceeding ₹[Threshold]\n`;
        contract += `    - Change in nature of business or entry into new business lines\n`;
        contract += `    - Appointment or removal of CEO, CFO, or statutory auditors\n`;
        contract += `    - Taking on debt exceeding ₹[Threshold]\n`;
        contract += `    - Commencement of litigation exceeding ₹[Threshold]\n`;
        contract += `    - Approval of annual budget and business plan\n`;
        contract += `    - Declaration of dividends\n`;
        contract += `    - Winding up or dissolution of the Company\n\n`;
        contract += `5. INFORMATION RIGHTS\n`;
        contract += `  a) Monthly management information system (MIS) reports within 15 days of month end.\n`;
        contract += `  b) Quarterly unaudited financial statements within 30 days of quarter end.\n`;
        contract += `  c) Annual audited financial statements within 90 days of financial year end.\n`;
        contract += `  d) Immediate notification of material events, litigation, or regulatory actions.\n`;
        contract += `  e) Right to inspect books, records, and premises upon reasonable notice.\n\n`;
        contract += `6. TRANSFER OF SHARES\n`;
        contract += `  a) Lock-in Period: Shareholders shall not transfer shares for [Duration] from the date of this Agreement.\n`;
        contract += `  b) Right of First Refusal (ROFR): Any shareholder wishing to sell shares must first offer them to existing shareholders at the same price and terms. Existing shareholders shall have [30/60] days to exercise ROFR.\n`;
        contract += `  c) Tag-Along Rights: If a majority shareholder sells more than [Percentage]% of their holding, minority shareholders may join in the sale on identical terms.\n`;
        contract += `  d) Drag-Along Rights: If shareholders holding [Percentage]%+ agree to sell to a bona fide third party, they may require all shareholders to sell on the same terms.\n`;
        contract += `  e) Permitted Transfers: Transfers to affiliates and family trusts are permitted without triggering ROFR, subject to the transferee executing a Deed of Adherence.\n`;
        contract += `  f) Transfer Restrictions: No transfer to competitors or their affiliates without unanimous consent.\n\n`;
        contract += `7. DIVIDEND POLICY\n`;
        contract += `  a) The Board shall recommend dividends based on distributable profits and applicable laws.\n`;
        contract += `  b) Minimum [Percentage]% of annual net profits shall be distributed as dividends, subject to working capital requirements.\n`;
        contract += `  c) Interim dividends may be declared by the Board subject to adequate profits.\n\n`;
        contract += `8. ANTI-DILUTION AND PRE-EMPTIVE RIGHTS\n`;
        contract += `  a) Each shareholder shall have pre-emptive rights to subscribe to new shares in proportion to their existing holdings.\n`;
        contract += `  b) In the event of a down-round, [Full Ratchet / Weighted Average] anti-dilution protection shall apply.\n`;
        contract += `  c) Pre-emptive rights must be exercised within [30/45] days of offer.\n\n`;
        contract += `9. NON-COMPETE AND NON-SOLICITATION\n`;
        contract += `  a) During the term of this Agreement and for [Duration] months thereafter, no shareholder or their affiliates shall engage in a business competing with the Company within ${details.jurisdiction || "[Territory]"}.\n`;
        contract += `  b) No shareholder shall solicit, recruit, or hire any employee, officer, or consultant of the Company.\n`;
        contract += `  c) No shareholder shall solicit or divert any customer, client, or supplier of the Company.\n\n`;
        contract += `10. CONFIDENTIALITY\n`;
        contract += `  a) All shareholders shall maintain strict confidentiality of Company information, trade secrets, and the terms of this Agreement.\n`;
        contract += `  b) Confidentiality obligations shall survive termination of this Agreement for [Duration] years.\n`;
        contract += `  c) Breach of confidentiality shall entitle the aggrieved party to seek injunctive relief and damages.\n\n`;
        contract += `11. DEADLOCK RESOLUTION\n`;
        contract += `In the event of a deadlock on Reserved Matters, the parties shall:\n`;
        contract += `  a) Step 1: Escalate to senior management/principals for good-faith negotiation for 30 days.\n`;
        contract += `  b) Step 2: If unresolved, submit to mediation under [Mediation Rules] for 30 days.\n`;
        contract += `  c) Step 3: If still unresolved, either party may trigger a buy-sell mechanism (Russian Roulette / Texas Shoot-out).\n`;
        contract += `  d) Step 4: If buy-sell is not exercised within 30 days, either party may initiate winding up.\n\n`;
        contract += `12. EXIT MECHANISMS\n`;
        contract += `  a) IPO: Shareholders agree to cooperate in any future public offering, subject to SEBI regulations and lock-in requirements.\n`;
        contract += `  b) Strategic Sale: Sale to a third-party buyer, subject to drag-along and tag-along provisions.\n`;
        contract += `  c) Buy-Back: The Company may buy back shares subject to Companies Act, 2013 and applicable laws.\n`;
        contract += `  d) Put Option: [Party] may require [Other Party] to purchase their shares at Fair Market Value after [Duration] years.\n`;
        contract += `  e) Call Option: [Party] may require [Other Party] to sell their shares at Fair Market Value after [Duration] years.\n`;
        contract += `  f) Liquidation: In the event of winding up, distribution shall be as per applicable law and this Agreement.\n\n`;
        contract += `13. REPRESENTATIONS AND WARRANTIES\n`;
        contract += `Each shareholder represents and warrants that:\n`;
        contract += `  a) They have full legal capacity to enter into this Agreement.\n`;
        contract += `  b) The execution of this Agreement does not violate any other agreement to which they are party.\n`;
        contract += `  c) They are the legal and beneficial owner of their shares, free from encumbrances.\n`;
        contract += `  d) No proceedings are pending that could materially affect their ability to perform obligations.\n\n`;
        contract += `14. INDEMNIFICATION\n`;
        contract += `Each party shall indemnify the other against any losses arising from breach of representations, warranties, or covenants under this Agreement.\n\n`;
        contract += `15. TERM\n`;
        contract += `This Agreement shall commence on ${details.effectiveDate || "[Start Date]"} and continue until ${details.endDate || "[End Date]"}, or until terminated by mutual consent, or until one party ceases to hold shares in the Company.\n\n`;
        break;

      case "term-sheet":
        contract += `TERM SHEET FOR PROPOSED INVESTMENT\n`;
        contract += `(Non-Binding except where expressly stated)\n\n`;
        contract += `${"─".repeat(60)}\n\n`;
        ...
        contract += `  CIN: [Company Identification Number]\n`;
        contract += `  Incorporation Date: [Date]\n\n`;
        contract += `2. INVESTOR DETAILS\n`;
        contract += `  Investor: ${details.party1Name}\n`;
        contract += `  Address: ${details.party1Address || "[Address]"}\n`;
        contract += `  Type: [Angel Investor / VC Fund / PE Fund / Strategic Investor]\n\n`;
        contract += `3. INVESTMENT AMOUNT AND STRUCTURE\n`;
        contract += `  Total Investment: ₹${details.amount || "[Amount]"}\n`;
        contract += `  Type of Security: [Equity Shares / Compulsorily Convertible Preference Shares (CCPS) / Compulsorily Convertible Debentures (CCD) / Convertible Notes]\n`;
        contract += `  Pre-Money Valuation: ₹[Valuation]\n`;
        contract += `  Post-Money Valuation: ₹[Valuation]\n`;
        contract += `  Price Per Share: ₹[Price]\n`;
        contract += `  Percentage Stake (Post-Investment): [Percentage]% on a fully diluted basis\n`;
        contract += `  Tranche Structure (if applicable):\n`;
        contract += `    - Tranche 1: ₹[Amount] at signing\n`;
        contract += `    - Tranche 2: ₹[Amount] upon achievement of [Milestone]\n\n`;
        contract += `4. USE OF PROCEEDS\n`;
        contract += `The investment shall be utilized solely for:\n`;
        contract += `  a) Product Development & Technology: [Percentage]%\n`;
        contract += `  b) Marketing, Sales & Customer Acquisition: [Percentage]%\n`;
        contract += `  c) Working Capital & Operations: [Percentage]%\n`;
        contract += `  d) Hiring & Team Expansion: [Percentage]%\n`;
        contract += `  e) General Corporate Purposes: [Percentage]%\n`;
        contract += `  f) Any deviation from the above shall require prior Investor approval.\n\n`;
        contract += `5. KEY TERMS\n`;
        contract += `  a) Board Seat: The Investor shall be entitled to [Number] Board seat(s) and [Number] Board observer seat(s).\n`;
        contract += `  b) Anti-Dilution: [Full Ratchet / Broad-Based Weighted Average] anti-dilution protection in the event of a down-round.\n`;
        contract += `  c) Liquidation Preference: [1x/2x] [non-participating / participating] liquidation preference on any liquidation event (including deemed liquidation events such as acquisition or merger).\n`;
        contract += `  d) Founder Vesting: Founders' shares to vest over [4] years with [1] year cliff. [Percentage]% shall vest on the cliff date, and the remainder shall vest monthly/quarterly.\n`;
        contract += `  e) ESOP Pool: [Percentage]% of the fully diluted share capital shall be reserved for an employee stock option plan.\n`;
        contract += `  f) Conversion: CCPS/CCD shall automatically convert into equity shares upon [IPO / Qualified Financing / Maturity Date].\n\n`;
        contract += `6. INVESTOR RIGHTS\n`;
        contract += `  a) Information Rights: Monthly MIS, quarterly financials, annual audited statements, and board packs at least [7] days before board meetings.\n`;
        contract += `  b) Inspection Rights: Access to books, records, and premises upon [7] days' reasonable notice.\n`;
        contract += `  c) Pro-Rata / Pre-Emptive Rights: Right to participate in future funding rounds to maintain pro-rata ownership percentage.\n`;
        contract += `  d) Approval Rights: Investor consent required for all Reserved Matters.\n`;
        contract += `  e) Affirmative Vote: Key decisions require affirmative vote of the Investor Director.\n`;
        contract += `  f) Observer Rights: Right to appoint a non-voting observer to all Board meetings.\n\n`;
        contract += `7. RESERVED MATTERS (INVESTOR CONSENT REQUIRED)\n`;
        contract += `  a) Any change in share capital, issuance of new securities, or creation of ESOP.\n`;
        contract += `  b) Any merger, acquisition, demerger, or change of control.\n`;
        contract += `  c) Related party transactions exceeding ₹[Threshold].\n`;
        contract += `  d) Annual budget approval and material deviations (>[Percentage]%).\n`;
        contract += `  e) Appointment/removal of CEO, CTO, CFO, or statutory auditors.\n`;
        contract += `  f) Change in nature of business, winding up, or dissolution.\n`;
        contract += `  g) Indebtedness exceeding ₹[Threshold].\n`;
        contract += `  h) Capital expenditure exceeding ₹[Threshold] per item or ₹[Threshold] annually.\n\n`;
        contract += `8. FOUNDER OBLIGATIONS\n`;
        contract += `  a) Full-time commitment to the Company (no moonlighting without consent).\n`;
        contract += `  b) Non-compete during tenure and for [24] months post-departure.\n`;
        contract += `  c) Non-solicitation of employees and clients for [24] months post-departure.\n`;
        contract += `  d) IP Assignment: All IP created shall vest with the Company. Founders to execute IP assignment deeds.\n`;
        contract += `  e) Key-Man Insurance: The Company shall obtain key-man insurance for each Founder.\n`;
        contract += `  f) Personal Guarantees: [Details if applicable].\n\n`;
        contract += `9. CONDITIONS PRECEDENT TO CLOSING\n`;
        contract += `  a) Satisfactory completion of legal, financial, and technical due diligence.\n`;
        contract += `  b) Execution of definitive agreements (SHA, SSA, Employment Agreements, IP Assignment).\n`;
        contract += `  c) Receipt of all regulatory and board approvals (RBI, FEMA if applicable).\n`;
        contract += `  d) No Material Adverse Change (MAC) in the Company's business, operations, or financial condition.\n`;
        contract += `  e) Delivery of all closing documents, including certified copies of resolutions, updated MoA/AoA.\n`;
        contract += `  f) Satisfactory reference checks on Founders.\n`;
        contract += `  g) Completion of Founder vesting documentation.\n\n`;
        contract += `10. EXCLUSIVITY AND NO-SHOP\n`;
        contract += `  a) The Company and Founders shall not solicit, negotiate with, or provide information to any other potential investor for a period of [60/90] days from the date of this Term Sheet.\n`;
        contract += `  b) Any approach from a third-party investor shall be promptly disclosed to the Investor.\n\n`;
        contract += `11. TIMELINE\n`;
        contract += `  Due Diligence Completion: ${details.effectiveDate || "[Date]"}\n`;
        contract += `  Definitive Agreements: [Date]\n`;
        contract += `  Closing / Funds Transfer: ${details.endDate || "[Date]"}\n`;
        contract += `  Long-Stop Date: [Date] (after which either party may terminate)\n\n`;
        contract += `12. EXIT AND LIQUIDITY\n`;
        contract += `  a) IPO: Best-efforts IPO within [5-7] years. The Investor shall have co-sale rights.\n`;
        contract += `  b) Strategic Sale: Drag-along rights if shareholders holding >[Percentage]% agree.\n`;
        contract += `  c) Buyback: Company may buy back Investor's shares at [Fair Market Value / IRR of X%].\n`;
        contract += `  d) Secondary Sale: Investor may transfer shares to another investor, subject to ROFR and Company consent.\n\n`;
        contract += `13. BINDING PROVISIONS\n`;
        contract += `Only Clauses 10 (Exclusivity), 14 (Confidentiality), 15 (Governing Law), and 16 (Expenses) of this Term Sheet are legally binding. All other provisions are indicative and subject to definitive agreements.\n\n`;
        contract += `14. CONFIDENTIALITY\n`;
        contract += `Both parties shall keep the terms of this Term Sheet strictly confidential and shall not disclose them to any third party (except legal and financial advisors bound by confidentiality) without prior written consent.\n\n`;
        contract += `15. GOVERNING LAW AND JURISDICTION\n`;
        contract += `This Term Sheet shall be governed by the laws of India. Disputes shall be subject to arbitration in ${details.jurisdiction || "[City]"} under the Arbitration and Conciliation Act, 1996.\n\n`;
        contract += `16. EXPENSES\n`;
        contract += `Each party shall bear its own costs and expenses. The Company shall reimburse the Investor's legal fees up to ₹[Amount] upon successful closing.\n\n`;
        break;
      ...
      case "investment":
        ...
        contract += `WHEREAS, the parties desire to set forth their respective rights and obligations in connection with such investment.\n\n`;
        contract += `NOW, THEREFORE, in consideration of the mutual covenants herein, the parties agree as follows:\n\n`;
        contract += `1. DEFINITIONS\n`;
        contract += `  a) "Closing" means the completion of the investment transaction as described in Clause 3.\n`;
        contract += `  b) "Fully Diluted Share Capital" means all outstanding shares plus shares issuable upon exercise of all options, warrants, and convertible securities.\n`;
        contract += `  c) "Material Adverse Change" means any event that materially and adversely affects the business, assets, financial condition, or prospects of the Company.\n`;
        contract += `  d) "Liquidation Event" includes winding up, dissolution, merger, acquisition, or sale of substantially all assets.\n\n`;
        contract += `2. INVESTMENT\n`;
        contract += `  a) The Investor agrees to invest ₹${details.amount || "[Amount]"} in the Company.\n`;
        contract += `  b) In exchange, the Company shall issue [Number] [equity shares / CCPS / CCD] representing [Percentage]% of the Company's fully diluted share capital.\n`;
        contract += `  c) Price per Share/Instrument: ₹[Amount].\n`;
        contract += `  d) The investment may be made in tranches as follows:\n`;
        contract += `    - Tranche 1: ₹[Amount] at Closing\n`;
        contract += `    - Tranche 2: ₹[Amount] upon achievement of [Milestone]\n\n`;
        contract += `3. VALUATION\n`;
        contract += `  a) Pre-Money Valuation: ₹[Amount]\n`;
        contract += `  b) Post-Money Valuation: ₹[Amount]\n`;
        contract += `  c) Price Per Share: ₹[Amount]\n`;
        contract += `  d) Valuation methodology: [DCF / Revenue Multiple / Comparable Transactions]\n\n`;
        contract += `4. CLOSING\n`;
        contract += `  a) The closing shall take place on or before ${details.endDate || "[Closing Date]"}.\n`;
        contract += `  b) At closing, the Investor shall wire the investment amount to the Company's designated bank account.\n`;
        contract += `  c) Simultaneously, the Company shall:\n`;
        contract += `    - Issue share certificates / allotment letters\n`;
        contract += `    - File necessary forms with the Registrar of Companies\n`;
        contract += `    - Update the Register of Members\n`;
        contract += `    - Deliver all closing documents as listed in Schedule B\n\n`;
        contract += `5. CONDITIONS PRECEDENT TO CLOSING\n`;
        contract += `  a) Completion of satisfactory legal, financial, and technical due diligence.\n`;
        contract += `  b) Execution of the Shareholders' Agreement and all ancillary agreements.\n`;
        contract += `  c) Receipt of all regulatory approvals (including RBI/FEMA approvals for foreign investment).\n`;
        contract += `  d) Board and shareholder resolutions authorizing the investment.\n`;
        contract += `  e) No Material Adverse Change in the Company's business.\n`;
        contract += `  f) Amendment of Articles of Association to incorporate Investor rights.\n`;
        contract += `  g) Delivery of all closing documents including legal opinions.\n`;
        contract += `  h) Completion of IP assignment by all founders and employees.\n`;
        contract += `  i) Execution of employment/service agreements with key founders.\n\n`;
        contract += `6. REPRESENTATIONS AND WARRANTIES BY THE COMPANY\n`;
        contract += `The Company and Founders jointly and severally represent and warrant that:\n`;
        contract += `  a) The Company is duly incorporated and validly existing under the Companies Act, 2013.\n`;
        contract += `  b) The Company has full power and authority to execute this Agreement.\n`;
        contract += `  c) The financial statements provided are true, accurate, and prepared in accordance with Indian GAAP/Ind AS.\n`;
        contract += `  d) There is no pending or threatened litigation, arbitration, or regulatory action that may materially affect the Company.\n`;
        contract += `  e) All intellectual property is owned by or validly licensed to the Company, free from encumbrances.\n`;
        contract += `  f) The Company is in compliance with all applicable laws, including tax laws, labor laws, and environmental laws.\n`;
        contract += `  g) All material contracts have been disclosed and are valid and subsisting.\n`;
        contract += `  h) There are no undisclosed liabilities, contingent or otherwise.\n`;
        contract += `  i) The Company has valid title to all assets and properties.\n`;
        contract += `  j) All tax returns have been filed and taxes paid. No tax proceedings are pending.\n`;
        contract += `  k) The capitalization table provided is accurate and complete.\n`;
        contract += `  l) No consent or approval is required other than as disclosed.\n\n`;
        contract += `7. REPRESENTATIONS AND WARRANTIES BY THE INVESTOR\n`;
        ...
        contract += `  b) The funds being invested are from legitimate sources and comply with anti-money laundering laws.\n`;
        contract += `  c) They are an accredited/sophisticated investor capable of evaluating the investment.\n`;
        contract += `  d) They are investing for their own account and not with a view to distribute.\n\n`;
        contract += `8. INVESTOR RIGHTS\n`;
        contract += `  a) Board Representation: The Investor shall appoint [Number] director(s) and [Number] observer(s) to the Board.\n`;
        contract += `  b) Information Rights: Monthly MIS within 15 days, quarterly financials within 30 days, annual audited statements within 90 days.\n`;
        contract += `  c) Anti-Dilution: [Full Ratchet / Broad-Based Weighted Average] protection in case of down rounds.\n`;
        contract += `  d) Liquidation Preference: [1x/2x] [non-participating / participating capped at Xx] preference on any Liquidation Event.\n`;
        contract += `  e) Pre-Emptive Rights: Right to participate in future issuances to maintain pro-rata ownership.\n`;
        contract += `  f) Co-Sale / Tag-Along Rights: Right to participate in any sale by Founders.\n`;
        contract += `  g) Drag-Along Rights: If Investor and shareholders holding >[Percentage]% agree to a sale, all shareholders must participate.\n`;
        contract += `  h) Right of First Refusal on any proposed share transfer.\n`;
        contract += `  i) Veto Rights on Reserved Matters (as defined in the Shareholders' Agreement).\n\n`;
        contract += `9. AFFIRMATIVE COVENANTS\n`;
        contract += `The Company shall:\n`;
        contract += `  a) Maintain proper books and records in accordance with applicable accounting standards.\n`;
        contract += `  b) Comply with all applicable laws, regulations, and contractual obligations.\n`;
        contract += `  c) Maintain adequate insurance coverage for assets, directors, and key personnel.\n`;
        contract += `  d) Use the investment proceeds strictly as per the agreed Use of Proceeds.\n`;
        contract += `  e) Maintain all governmental licenses and permits.\n`;
        contract += `  f) Conduct annual audits by a reputed audit firm approved by the Investor.\n`;
        contract += `  g) Promptly notify the Investor of any Material Adverse Change or material litigation.\n\n`;
        contract += `10. NEGATIVE COVENANTS (RESERVED MATTERS)\n`;
        contract += `Without prior written Investor consent, the Company shall not:\n`;
        contract += `  a) Issue new shares, securities, or grant ESOPs beyond the approved pool.\n`;
        contract += `  b) Declare or pay dividends.\n`;
        contract += `  c) Incur debt or contingent liabilities beyond ₹[Threshold].\n`;
        contract += `  d) Enter into related party transactions exceeding ₹[Threshold].\n`;
        contract += `  e) Change the nature of business or enter new business verticals.\n`;
        contract += `  f) Amend the Memorandum or Articles of Association.\n`;
        contract += `  g) Approve the annual budget or deviate materially (>[Percentage]%) from it.\n`;
        contract += `  h) Make capital expenditures exceeding ₹[Threshold].\n`;
        contract += `  i) Hire or terminate senior management (CXO level).\n`;
        contract += `  j) Create any lien or encumbrance on Company assets.\n\n`;
        contract += `11. FOUNDER OBLIGATIONS\n`;
        contract += `  a) Full-time commitment to the Company. No engagement in other business activities.\n`;
        contract += `  b) Founder shares shall vest over [4] years with [1] year cliff.\n`;
        contract += `  c) Non-compete during tenure and for [24] months post-departure.\n`;
        contract += `  d) Non-solicitation of employees and clients for [24] months post-departure.\n`;
        contract += `  e) All existing and future IP to be assigned to the Company.\n`;
        contract += `  f) Founders shall not transfer shares during the lock-in period of [Duration].\n\n`;
        contract += `12. TRANSFER RESTRICTIONS\n`;
        contract += `  a) Lock-in: Founders shall not transfer shares for [Duration] from Closing.\n`;
        contract += `  b) ROFR: Right of first refusal on any proposed transfer. [30] days to exercise.\n`;
        contract += `  c) Tag-Along and Drag-Along rights as per the Shareholders' Agreement.\n`;
        contract += `  d) No transfer to competitors or sanctioned entities.\n\n`;
        contract += `13. INDEMNIFICATION\n`;
        contract += `  a) The Company and Founders shall jointly and severally indemnify the Investor against any losses arising from breach of representations, warranties, or covenants.\n`;
        contract += `  b) Indemnification Cap: [Percentage]% of the investment amount (except for fraud, which shall be unlimited).\n`;
        contract += `  c) Indemnification Basket: Claims shall be aggregated and the threshold for claims is ₹[Amount].\n`;
        contract += `  d) Survival: Representations and warranties shall survive for [Duration] years from Closing. Tax and title warranties shall survive indefinitely.\n\n`;
        contract += `14. TERMINATION\n`;
        contract += `  a) This Agreement may be terminated prior to Closing by mutual written consent.\n`;
        contract += `  b) Either party may terminate if Closing has not occurred by the Long-Stop Date.\n`;
        contract += `  c) The Investor may terminate if there is a Material Adverse Change.\n`;
        contract += `  d) Upon termination, each party's obligations shall cease except for confidentiality, which shall survive.\n\n`;
        contract += `15. TERM\n`;
        contract += `This Agreement shall be effective from ${details.effectiveDate || "[Start Date]"} and remain in force until the Investor exits the Company through an approved exit mechanism.\n\n`;
        break;
