...
export const routeMap: Record<string, RouteInfo> = {
  ...
  "/ais-tis-reconciliation": { label: "AIS/TIS Reconciliation", parent: "/prototypes" },
  "/presumptive-tax": { label: "Presumptive Tax Calculator", parent: "/prototypes" },
  "/crypto-tax": { label: "Crypto Tax Calculator", parent: "/prototypes" },
  "/nri-tax": { label: "NRI Tax Calculator", parent: "/prototypes" },
  "/asset-allocation": { label: "Asset Allocation Optimizer", parent: "/prototypes" },
  "/ipo-analysis": { label: "IPO Analysis Tool", parent: "/prototypes" },
  "/bond-ladder": { label: "Bond Ladder Calculator", parent: "/prototypes" },
  "/human-life-value": { label: "Human Life Value Calculator", parent: "/prototypes" },
  "/multiple-goals": { label: "Multiple Goals Dashboard", parent: "/prototypes" },
  "/inflation-corpus": { label: "Inflation-Adjusted Corpus", parent: "/prototypes" },
  "/breakeven-analysis": { label: "Break-even Analysis", parent: "/prototypes" },
  "/working-capital": { label: "Working Capital Calculator", parent: "/prototypes" },
  "/invoice-aging": { label: "Invoice Aging Dashboard", parent: "/prototypes" },
  "/subscription-audit": { label: "Subscription Audit Tool", parent: "/prototypes" },
  "/side-hustle": { label: "Side Hustle Tracker", parent: "/prototypes" },
  "/expense-split": { label: "Expense Split Calculator", parent: "/prototypes" },
  "/rent-receipt": { label: "Rent Receipt Generator", parent: "/prototypes" },
  "/emi-prepayment": { label: "EMI Prepayment Optimizer", parent: "/prototypes" },
};
