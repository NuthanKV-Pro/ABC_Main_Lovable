...
export const routeMap: Record<string, RouteInfo> = {
  ...
  "/my-financial-profile": { label: "My Financial Profile", parent: "/prototypes" },
  "/quick-summary": { label: "Quick Summary", parent: "/prototypes" },
  "/other-tools": { label: "Other Tools", parent: "/prototypes" },
  "/ais-tis-reconciliation": { label: "AIS/TIS Reconciliation", parent: "/other-tools" },
  "/presumptive-tax": { label: "Presumptive Tax Calculator", parent: "/other-tools" },
  "/crypto-tax": { label: "Crypto Tax Calculator", parent: "/other-tools" },
  "/nri-tax": { label: "NRI Tax Calculator", parent: "/other-tools" },
  "/asset-allocation": { label: "Asset Allocation Optimizer", parent: "/other-tools" },
  "/ipo-analysis": { label: "IPO Analysis Tool", parent: "/other-tools" },
  "/bond-ladder": { label: "Bond Ladder Calculator", parent: "/other-tools" },
  "/human-life-value": { label: "Human Life Value Calculator", parent: "/other-tools" },
  "/multiple-goals": { label: "Multiple Goals Dashboard", parent: "/other-tools" },
  "/inflation-corpus": { label: "Inflation-Adjusted Corpus", parent: "/other-tools" },
  "/breakeven-analysis": { label: "Break-even Analysis", parent: "/other-tools" },
  "/working-capital": { label: "Working Capital Calculator", parent: "/other-tools" },
  "/invoice-aging": { label: "Invoice Aging Dashboard", parent: "/other-tools" },
  "/subscription-audit": { label: "Subscription Audit Tool", parent: "/other-tools" },
  "/side-hustle": { label: "Side Hustle Tracker", parent: "/other-tools" },
  "/expense-split": { label: "Expense Split Calculator", parent: "/other-tools" },
  "/rent-receipt": { label: "Rent Receipt Generator", parent: "/other-tools" },
  "/emi-prepayment": { label: "EMI Prepayment Optimizer", parent: "/other-tools" },
};
